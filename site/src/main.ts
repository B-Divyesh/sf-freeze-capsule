...
const terminal = (interactive = false) => `
  <section class="terminal-sheet" aria-labelledby="terminal-title">
    <div class="plate-label"><span>DETAIL A</span><span>BUNDLED CLI SAMPLE</span></div>
    ...
    <p class="terminal-note">The browser uses a fixture generated from <code>freeze-capsule --json demo</code>.</p>
  </section>`;
